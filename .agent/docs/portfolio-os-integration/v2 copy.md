...
- **Checklist:**
  ...
  - [ ] definir quais arquivos do fluxo atual deixam de ser fonte de verdade para `work`
  - [ ] documentar explicitamente que `pages` fica fora da Fase 1
- Critério de aceite:
  - existe uma baseline fechada dos 3 cases, com referência HTML e rota pública de cada um
